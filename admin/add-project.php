      ...
      <div id="wrapper">
         <!-- Sidebar -->
		   ...
		   include "config.php"; 
			...
			$stmt = $dbh->query("SELECT * FROM project_name WHERE project_name.id='".@$_GET['id']."'");
			$row=$stmt->fetch();
			$id=$row['id'];
                  ...
                  <div class="row">
                     ...
                     <div class="col-xl-12 col-lg-12" style="display:">
                        <div class="card shadow mb-4">
                           ...
                           <!-- Card Body -->
                           <div class="card-body">
                              <form method="POST" <?php if(@$_GET['id']){?>action="update/update_project_name.php"<?php }else{?>action="add/add_project_name.php"<?php }?>>
                                 <input type="hidden" name="project_name_id" value="<?php echo $id; ?>">
                                <div class="form-group">
									<span>HEAD IMAGE</span>
                                    <input type="file"  id="photo">
									<input type="hidden" name="thumbnail" class="get-photo"  value="<?php echo $head_image?>"></br><b>Select an image as given ratio.</b> 
								...
								<div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="project_name" class="form-control" value="<?php echo $name;?>" placeholder="Project Name" required />
                                 </div>
                                   
                                  <div class="form-group">
									<label for="usr"><strong>Description About Project </strong></label>
								  <textarea name="description" class="form-control" id="the-textarea" maxlength="300" rows="4" placeholder="Start Typin..."autofocus><?php echo $description;?></textarea>
								  <div id="the-count">
                                  ...
                                  <select name="project_type_id" class="form-control">
									...
									<?php 
                                                ...
                                                while ($rowprojecttype = $stmtprojecttype->fetch()){
													if($rowprojecttype["project_type"]=="Real State"){
														continue;
													}	
