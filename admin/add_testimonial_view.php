        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Testimonial</h1>
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" id="addtestimonial" method="POST">
                                <div class="form-group row">
									...
									<div class="col-sm-12 mb-3 mb-sm-3">
                                        <input type="text" name="postion" class="form-control " id="exampleFirstName"
                                            placeholder="Postion Title">
                                    </div>
									 <div class="col-sm-12 mb-3 mb-sm-3">
                                        <input type="text" name="content" class="form-control " id="exampleFirstName"
								...
								<span>Upload thumbnail :</span>
									...
									<input type="hidden" name="thumbnail" class="get-photo"  value="">
