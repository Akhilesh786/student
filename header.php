                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="header-button">
                                ...
                                <a href="ecg-report" class="th-btn th-radius2">Check ECG Report</a>
<!--                                 <button type="button" class="icon-btn sideMenuToggler d-none d-xl-inline-block"><i class="far fa-bars"></i></button>
